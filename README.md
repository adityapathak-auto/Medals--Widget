...
* [`src/form_app/`](src/form_app/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/form_app/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `form_app` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/form_app/config.cljs) defaults to `true` in
...
```clj
(ns form-app.example
  (:require [form-app.config :as config])
